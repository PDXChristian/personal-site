...
({
	...
	return (
		<>
			<nav className="flex items-center flex-wrap bg-blue-900 p-3 dark:bg-dark-pallet-navbar" onClick={focusSearch}>
				<span className="text-xl text-white dark:text-dark-pallet-base font-bold tracking-wide">
					<Link href="/">
